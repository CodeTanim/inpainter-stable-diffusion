    ...
    <div>
      ...
      <main className="container mx-auto p-5 bg-gray-900 text-white"> 
        ...
        <div className="border-hairline max-w-[512px] mx-auto relative bg-gray-800 border-gray-600"> {/* Dark theme for the image input area */}
          ...
          />
          <div
            className="bg-gray-700 relative max-h-[512px] w-full flex items-stretch"
        ...
        <div className="max-w-[512px] mx-auto">
          ...
          <div className="text-center">
            {((predictions.length > 0 &&
              ...
              maskImage ||
              userUploadedImage) && (
              <button className="lil-button bg-gray-700 border-gray-500 hover:bg-gray-600"> {/* Adjusted button colors */}
